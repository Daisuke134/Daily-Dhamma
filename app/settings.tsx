...
import { ChevronLeft, Bell, Sun, Moon, Clock, ExternalLink, Crown, Info } from 'lucide-react-native';
...
export default function SettingsScreen() {
  ...
  const handleFrequencyChange = (frequency: 5 | 7 | 10) => {
  ...
  const FrequencyButton = ({ value, label }: { value: 5 | 7 | 10; label: string }) => {
